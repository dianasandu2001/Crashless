...
print(
    f"\nHello {userName}, welcome to our flight game!\nYour goal is to visit 5 different countries without running "
    f"out of fuel. Your starting point is Helsinki Vantaa Airport, Finland.\nYou have been given {fuel} liters of "
    f"fuel, and will be given the opportunity to gain more later by answering trivia qustions.\nHave fun and good "
    f"luck! :)")
displayvar()
